...
;(window.webpackJsonp = window.webpackJsonp || []).push([
  [6],
  {
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          ...
                          return (
                            (t.prev = 5),
                            (t.next = 8),
                            n.fetchPayload(O.routePath || n.context.route.path)
                          )
                        case 8:
                          ;(r = t.sent), Object.assign(O, r), (t.next = 14)
                          break
                        case 12:
      ...
      function w(t) {
        for (var i = 0; i < t.length; i++) {
          ...
          if (n) {
            ...
            for (; r < e.parts.length; r++) n.parts.push($(e.parts[r]))
            n.parts.length > e.parts.length && (n.parts.length = e.parts.length)
          } else {
            var o = []
            for (r = 0; r < e.parts.length; r++) o.push($(e.parts[r]))
    ...
    21: function (t, e, n) {
      ...
      var r = n(3),
        o = n(24),
        c = (n(45), n(16), n(35), n(17), n(61), n(1)),
        f = n(49),
        l = n(121),
        h = n(86),
        d = n.n(h),
      ...
      })(n(186), 'store/index.js')).modules = z.modules || {}
      var F =
      ...
      function G(path, t) {
        var e =
          ...
          n = Array.isArray(path)
            ...
            : path in this.state
        return V.call(this, path, t, H({ preserveState: n }, e))
      }
      function Q(t) {
        return Y.apply(this, arguments)
      }
            ...
            return regeneratorRuntime.wrap(function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 4:
                    return (
                      ...
                      e
                        ...
                        : ((path = Object(w.g)(o.options.base, o.options.mode)),
                  ...
                  case 20:
                    return t.abrupt('return', { store: f, app: l, router: o })
                  case 21:
                  case 'end':
                    return t.stop()
                }
